...
public:
    ...
    const AncestorDependentProperties& ancestorDependentProperties() { 
        // ASSERT(!m_needsToUpdateAncestorDependentProperties); // XXX(Roberto): commented to avoid Chromium's own bug on Amazon.com
        return m_ancestorDependentProperties; }
